...
async def force_restore(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user_id = update.effective_user.id
    # Optional: Restrict to admin only - replace with your user ID
    ADMIN_ID = 7300957726  # ⚠️ CHANGE THIS TO YOUR ACTUAL USER ID
    if user_id != ADMIN_ID:
...
# Then in your main function where you add handlers, include:
